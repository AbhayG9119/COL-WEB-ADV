...
import SetFeeStructure from '../components/Admin Pannel/SetFeeStructure';
import TransportManagement from '../components/Admin Pannel/TransportManagement';
import HostelManagement from '../components/Admin Pannel/HostelManagement';
import DiscountManagement from '../components/Admin Pannel/DiscountManagement';
import SubjectManagement from '../components/Admin Pannel/SubjectManagement';
...
import DuplicateReceipt from '../components/Admin Pannel/DuplicateReceipt';
...
const AdminPanel = () => {
  ...
  const menus = [
    ...
    { name: 'Academic Management', sub: ['Session Management', 'Set Fee Structure', 'Transport Routes & Fare', 'Hostel Fees', 'Generate Discount', 'Add Subject'] },
    { name: 'Registration & Admission', sub: ['Registration', 'New Admission'] },
    { name: 'Fees & Receipts', sub: ['Collect Fees', 'Duplicate Receipt', 'Cancel Receipt', 'Change Hostel/Transport'] },
  ...
  const componentMap = {
    ...
    'Set Fee Structure': SetFeeStructure,
    'Transport Routes & Fare': TransportManagement,
    'Hostel Fees': HostelManagement,
    'Generate Discount': DiscountManagement,
    'Add Subject': SubjectManagement,
