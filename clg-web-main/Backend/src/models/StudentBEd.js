...
const studentBEdSchema = new mongoose.Schema({
  username: { type: String, required: true, unique: true },
  email: { type: String, required: true, unique: true },
  password: { type: String, required: true },
  department: { type: String, default: 'B.Ed' },
  ...
  college: { type: String },
  course: { type: String, default: 'B.Ed' },
  branch: { type: String },
...
studentBEdSchema.pre('save', async function(next) {
...
studentBEdSchema.methods.comparePassword = async function(candidatePassword) {
  return await bcrypt.compare(candidatePassword, this.password);
};

const StudentBEd = mongoose.model('StudentBEd', studentBEdSchema);
